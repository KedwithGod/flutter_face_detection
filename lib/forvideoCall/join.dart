...
import 'package:testing_camera/forvideoCall/call.dart';
import 'package:testing_camera/forvideoCall/signalling.dart';
...
class _JoinScreenState extends State<JoinScreen> {
  ...
  final remoteCallerIdTextEditingController = TextEditingController();
   // socket instance
  final socket = SignallingService.instance.socketListen;
  ...
  void initState() {
    ...
    socket!.listen( (data) {
      if (mounted) {
        ...
        setState(() => incomingSDPOffer = jsonDecode(data));
      }
    });
  }
